                            ...
                            <div class="card-columns">
                                ...
                                <div class="card product-card">
                                    ...
                                    <div class="card-footer text-center">
                                        ...
                                        <button class="btn btn-outline-success">&#8377;<%= p.getPriceAfterApplyingDiscount()%>/- <span class="text-secondary discount-label">&#8377;<%= p.getpPrice()%>, <%= p.getpDiscount()%>% off</span></button>                                  </div>
